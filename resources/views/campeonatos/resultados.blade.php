...
@section('title', 'Resultados do Campeonato')
@section('content')
        ...
        <div>
          ...
          <div class="flex gap-2 justify-center text-sm">
            ...
            <p class="text-white flex items-center gap-2">
              ...
              <time datetime="{{$campeonato->data_realizacao}}">{{$campeonato->data_realizacao}}</time>
            </p>
          </div>
        </div>
      </div>
    ...
    <main class="max-w-7xl mx-2 lg:mx-auto">
      ...
      <section class="rounded-md outline outline-1 outline-gray-200 px-2 py-4">
        ...
        <h4 class="text-center text-2xl text-gray-800 my-2">{{$atleta->peso}}</h4>
        <div class="grid lg:grid-cols-2 gap-4">
          <div class="text-gray-900">
            <h4 class="text-xl border-b pb-2 border-gray-200">{{$atleta->sexo}}</h4>
            <ul class="mt-2">
              <li
                class="odd:bg-gray-200 even:bg-gray-50 flex items-stretch border-b border-gray-100"
              >
                <span
                  class="bg-blue-700 text-white inline-flex items-center justify-center py-2 px-4"
                >
                  {{$atleta->primeiro_colocado}}
                </span>
                <p class="ml-2 font-bold py-1">
                  {{$atleta->nome}}
                  <span class="block text-blue-700 font-normal text-sm"
                    >{{$atleta->equipe}}</span
                  >
                </p>
              </li>
