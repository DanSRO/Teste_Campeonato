...
<head>
    ...
    <title>@yield('title', 'Campeonato de Jiu-Jitsu')</title>   
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        ...
        >
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            >
              ...
              <li>
                <a
                  href="{{route('area_atleta.area_restrita')}}"
    ...
    >
      ...
      >
        ...
        >
          ...
          <li>
            <a href="{{route('busca.campeonatos')}}" class="mr-4 hover:underline md:mr-6"
              >Torneios</a
            >
          </li>
          <li>
            <a href="{{route('area_atleta.area_restrita')}}" class="mr-4 hover:underline md:mr-6"
