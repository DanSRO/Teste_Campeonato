...
<html lang="pt-br">
  ...
  <body>
    <header>
      <nav class="bg-white border-gray-200">
        ...
        >
          <a href="{{route('campeonatos.index')}}" class="flex items-center">
  ...
  @csrf
        ...
        @if ($errors->any())
        <div class="alert alert-danger" style="text-align: center; background-color:deeppink;">
            <ul>
