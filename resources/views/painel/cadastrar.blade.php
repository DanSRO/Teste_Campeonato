    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
            ...
            <div class="menu">
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        ...
                        <a href="{{route('user.store')}}" class="submenu-link link-light text-decoration-none rounded p-2">
                            <small class="d-flex justify-content-between align-items-center">
                                Cadastrar
                            </small>
                        </a>
                        <a href="{{ route('user.index') }}" class="submenu-link link-light text-decoration-none rounded p-2">
                            <small class="d-flex justify-content-between align-items-center">
                                Listagem
                            </small>
                        </a>
                ...
                <a href="{{route('logar')}}" class="w-100 d-flex align-items-center gap-2 link-light text-decoration-none mt-2 py-3 px-3 ms-1 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(-.125rem, 0, 0);">
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex align-items-end justify-content-between mb-4">
                ...
                <a href="{{route('user.index')}}" class="btn btn-light">Voltar</a>
            </div>

            <form action="{{ route('user.store') }}" method="post" class="bg-custom rounded col-12 py-3 px-4">
            @csrf  
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="senha_confirmation" class="form-control bg-dark text-light border-dark" id="confSenha">
                    </div>
                </div>
