                ...
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            ...
                            <a href="{{route('user.index')}}" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{route('user.store')}}" class="btn btn-light">+ Cadastrar Usuário</a>
                </div>
            </div>

            <div class="d-flex justify-content-between align-items-end mb-3">
                <form action="{{ route('user.filter') }}" method="get" class="bg-custom rounded col-12 py-3 px-4">
                @csrf
