...
<body>
        ...
        <nav class="bg-white border-gray-200">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:items-center md:space-x-8 md:mt-0 md:border-0 md:bg-white">
                        <li>
    ...
    <main>
        ...
        <section aria-labelledby="torneios_destaque_titulo" class="py-12">
            <h2 class="font-bold text-center text-3xl uppercase" id="torneios_destaque_titulo">Torneios em Destaque</h2>
            ...
            @endforeach
            {{ $campeonatosDestaques->links() }}
            @endisset
                    {{--

                @foreach($campeonatosNaoDestaques as $campeonato)
                    <!-- Exibir detalhes do campeonato não em destaque -->
                @endforeach
        ...
        <section aria-labelledby="torneios_titulo" class="py-12">
            ...
            @empty
            <p>Nenhum atleta em destaque no momento.</p>
            @endforelse
            @endisset                    
            ...
            <p class="mt-4 max-w-7xl mx-auto flex justify-center md:justify-end">
                <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <footer class="bg-white rounded-lg shadow max-w-7xl m-4 md:mx-auto md:mt-4 outline outline-1 outline-gray-300">
        <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-500 sm:text-center">© 2023 <a href="/" class="hover:underline">OSU BJJ</a>. Todos os
                direitos reservados.
            </span>
